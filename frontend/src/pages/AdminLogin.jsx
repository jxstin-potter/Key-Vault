    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-neutral-100 rounded-2xl shadow-large p-8">
          ...
          {/* Admin credentials are deliberately not shown here. This page is
              public, so printing them hands anyone who finds the URL the
              ability to manage products, keys and customer data. The shopper
              demo account stays advertised on the regular /login page, where
              the worst it grants is a test shopping session. */}
        </div>
